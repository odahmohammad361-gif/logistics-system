...
from app.api.v1 import auth, users, clients, invoices, service_quotes, shipping_agents, clearance_agents, market, company, branches, reference, bookings, warehouses, suppliers, products, shop, customers, client_portal, accounting, customs_calculator, customs_references
...
app.include_router(service_quotes.router,   prefix=f"{API_PREFIX}/service-quotes",   tags=["Service Quotes"])
