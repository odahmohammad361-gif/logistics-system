...
export const PAYMENT_TERM_LABELS: Record<string, { en: string; ar: string }> = {
  ...
  '30% deposit / 70% before shipping': { en: '30% deposit / 70% before shipping', ar: '30% دفعة مقدمة / 70% قبل الشحن' },
  '50% deposit / 50% before shipping': { en: '50% deposit / 50% before shipping', ar: '50% دفعة مقدمة / 50% قبل الشحن' },
  '70% deposit / 30% before delivery': { en: '70% deposit / 30% before delivery', ar: '70% دفعة مقدمة / 30% قبل التسليم' },
